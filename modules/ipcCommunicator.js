            ...
            */
            ...
            if (type === 'ethersale') {
                ...
                // geth
                    ...
                    if (process.platform === 'darwin') keystorePath += '/Library/Struena/keystore';

                    if (process.platform === 'freebsd' ||
                        process.platform === 'linux' ||
                        process.platform === 'sunos') keystorePath += '/.struena/keystore';

                    if (process.platform === 'win32') keystorePath = `${Settings.appDataPath}\\Struena\\keystore`;
                }
...
ipc.on('backendAction_importWalletFile', (e, path, pw) => {
    ...
    const binPath = ClientBinaryManager.getClient('struena').binPath;
